...
import { JhipsterOnlineApplicationCoreModule } from 'app/core';
...
import { JhipsterOnlineApplicationAccountModule } from './account/account.module';
...
@NgModule({
  imports: [
    ...
    JhipsterOnlineApplicationSharedModule.forRoot(),
    JhipsterOnlineApplicationCoreModule,
    JhipsterOnlineApplicationHomeModule,
    JhipsterOnlineApplicationAccountModule,
